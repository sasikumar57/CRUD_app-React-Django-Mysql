...
SECRET_KEY = 'django-insecure-6k3o55)r*b@^%*2b-m(ct71(cl9im5el^&m2216=6e!=md(q+r'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'sms',  # Replace 'sms' with your database name
        'USER': 'root',  # Your MySQL username
        'PASSWORD': 'Sasi@2001',  # Your MySQL password
